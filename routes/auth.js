...
router.put('/cleanstudentemail/:schoolId',verifyToken, cleanStudentFields);
...
router.get('/getUserByFilter/:userid',verifyToken, getUserByFilter);router.post('/forgotpassword', forgotPassword);
