...
// middleware
app.use(cors({
  origin: ["http://localhost:8080","http://localhost:3000","http://127.0.0.1:5503", "https://xpay.jolade-boluwatife.workers.dev"], // For dev only; replace with your frontend URL in production
