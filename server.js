...
app.use(cors({
  origin: [
    "http://localhost:8080","http://localhost:3000","http://127.0.0.1:5503","http://localhost:5174", "https://xpay.jolade-boluwatife.workers.dev","https://nodes-production-2b39.up.railway.app",
